  ...
  return (
    <footer className="bg-white pt-6">
      <div className="container-marklab">
        ...
        {/* Footer grid */}
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(280px,400px)_1fr] gap-14 lg:gap-20 py-16 lg:py-20">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-small mt-0.5">Indore, Madhya Pradesh, India</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:Techcoinfotech@gmail.com" className="text-small mt-0.5 hover:text-[#4555fd] transition-colors block">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-[#0b0d21]">Phone</p>
                  <a href="tel:+916232551312" className="text-small mt-0.5 hover:text-[#4555fd] transition-colors block">
                    +91-6232551312
                  </a>
              ...
              {subscribed ? (
                ...
                >
                  <input
                    ...
                    className="w-full h-12 rounded-full border border-[#e6e6e6] pl-5 pr-14 text-sm text-[#0b0d21] placeholder:text-[#a2a3b1] focus:outline-none focus:border-[#4555fd] transition-colors bg-[#fafafa]"
                  />
                  <button
                    type="submit"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 lg:gap-12">
            {columns.map((col) => (
              <div key={col.title}>
                <p className="text-[#a2a3b1] text-sm font-medium uppercase tracking-wider mb-6">{col.title}</p>
            ...
            <div>
              <p className="text-[#a2a3b1] text-sm font-medium uppercase tracking-wider mb-6">Social</p>
              <ul className="space-y-4">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#f0f0f0] py-8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-small text-[#a2a3b1]">
